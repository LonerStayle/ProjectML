...
│ - "memory_recall": 과거 대화 → User Memory 검색 후 응답 (4요소 하이브리드)│
...
│ data:  물어보시다니                                                       │
│ data: .                                                                  │
│ data: {"type": "final", "affection": 52, "sanity": 100, "memoryProgress": 32, "emotion": 0}│
│ data: [DONE]                                                             │
└───────────────────────────────────┬─────────────────────────────────────┘
                                    │
                                    ▼
              (스트리밍 완료 후 상태 업데이트 - LLM 재호출 없이)
              (Redis 세션 저장, User Memory 기억 저장)
```
